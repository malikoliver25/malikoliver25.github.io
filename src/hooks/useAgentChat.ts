...
function localMockReply(last: string): string {
  ...
  if (q.includes('primary role') || q.includes('strongest role') || q.includes('what is his role') || q.includes('what does malik do')) return `Primary: MLOps & AI Infrastructure Engineer. Strongest: MLOps/AI Orchestration — Level 5 in K8s, Docker, CI/CD, Python, FastAPI, LangGraph, Agentic Arch, vLLM. That’s his superpower.`;
